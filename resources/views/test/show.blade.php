...
@section('title')
    ...
    <h1 class="page-title"> Visualizar exame
    </h1>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="btn-group pull-right">
                                            <a href="{{ route('exames.index') }}" class="btn sbold default"> Voltar <i class="fa fa-rotate-left"></i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="row">
                                        <div class="col-md-offset-3 col-md-9">
                                            <a href="{{ route('exames.edit', $exam->id) }}" class="btn green"> <i class="fa fa-pencil"></i> Editar </a>
                                        </div>
                                    </div>
                                </div>
